...
create procedure sp_area_seleccionar_id( @id tinyint )
as
begin
...
create procedure sp_area_filtrar_nombre( @nombre varchar (20))
as
begin
...
create procedure sp_area_buscar_id( @id tinyint, @encontrado tinyint output )
as
begin
...
create procedure sp_area_buscar_nombre( @nombre varchar(45), @encontrado tinyint output )
as
begin
