...
namespace Presentacion
{
    ...
    {
        private static FormEmpleado iform_area = null;
        ...
        public static FormEmpleado FormArea_Instanciar()
        {
            if (iform_area == null || iform_area.IsDisposed == true)
            {
                iform_area = new FormEmpleado();
            }
